...
<div class="container bootdey d-flex align-item-center justify-content-center mt-auto" style="border:2px solid red;">
    <div class="col-md-12 ">
        <section class="panel">
            <div class="panel-body>
                <div class=" col-md-6">
                <div class="pro-img-details">
                    <img src="images\bags\Bottles & Caps\main.png" height="500px" alt="">
                </div>
                <div class=" pro-img-list">
                    <a href="#">
                        <img src="images\bags\Bottles & Caps\pmain.png" alt="">
                    </a>
                    <a href="#">
            ...
            <div class="col-md-6">
                ...
                <div class="product_meta">
                    <span class="posted_in"> <strong>Categories:</strong> <a rel="tag" href="#">Jackets</a>, <a
                            rel="tag" href="#">Men</a>, <a rel="tag" href="#">Shirts</a>, <a rel="tag"
                            href="#">T-shirt</a>.</span>
                    <span class="tagged_as"><strong>Tags:</strong> <a rel="tag" href="#">mens</a>, <a rel="tag"
                            href="#">womens</a>.</span>
                </div>
                ...
                <p>
                    <button class="btn btn-round btn-danger" type="button"><i class="fa fa-shopping-cart"></i> Add
                        to Cart</button>
                </p>
            </div>
    </div>
